...
#
# Purpose:     This module is used to package the Phishperida project as a black
#              box API for other project to use 
...
class phishperidaPKG():

    def __init__(self, driverType="C"):
        self.resultsPath = os.path.join(DRI_PATH, 'pedia_rlt.txt')
